...
\leavevmode%
\begin{enumerate}
\item\hypertarget{li-61}{}\(\mc T\) is said to be \terminology{regular} if and only if for all points \(x\in X\) and closed subsets \(H\subseteq X\) such that \(x\not\in H\), there exist open sets \(U,V\in\mc T\) such that \(x\in U,H\subseteq V,U\cap V=\emptyset\).%
\item\hypertarget{li-62}{}\(\mc T\) is said to be \terminology{\(T_3\)} if and only if it is both regular and \(T_1\)%
\item\hypertarget{li-63}{}\(\mc T\) is said to be \terminology{normal} if and only if for all closed subsets \(H,L\subseteq X\) such that \(H\cap L=\emptyset\), there exist open sets \(U,V\in\mc T\) such that \(H\subseteq U,L\subseteq V,U\cap V=\emptyset\).%
\item\hypertarget{li-64}{}\(\mc T\) is said to be \terminology{\(T_4\)} if and only if it is both normal and \(T_1\)%
\end{enumerate}
\end{definition}
...
\leavevmode%
\begin{enumerate}
\item\hypertarget{li-65}{}\(T_2\) but not regular.%
\item\hypertarget{li-66}{}\(T_3\) but not \(T_4\)%
\item\hypertarget{li-67}{}Regular but not \(T_3\).%
\item\hypertarget{li-68}{}Normal but not \(T_4\).%
\item\hypertarget{li-69}{}Regular but not normal.%
\item\hypertarget{li-70}{}Normal but not regular.%
\end{enumerate}
\end{example}
