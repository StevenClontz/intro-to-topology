...
\hypertarget{p-192}{}%
Let \(X^*\) be a quotient space of \(X\). Then \(V\subseteq X^*\) is open if and only if \(\bigcup V\subseteq X\) is open.%
\end{theorem}
