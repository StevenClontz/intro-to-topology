...
\leavevmode%
\begin{enumerate}
\item\hypertarget{li-55}{}\(\mc T\) is said to be \terminology{regular} if and only if for all points \(x\in X\) and closed subsets \(H\subseteq X\) such that \(x\not\in H\), there exist open sets \(U,V\in\mc T\) such that \(x\in U,H\subseteq V,U\cap V=\emptyset\).%
\item\hypertarget{li-56}{}\(\mc T\) is said to be \terminology{\(T_3\)} if and only if it is both regular and \(T_1\)%
\item\hypertarget{li-57}{}\(\mc T\) is said to be \terminology{normal} if and only if for all closed subsets \(H,L\subseteq X\) such that \(H\cap L=\emptyset\), there exist open sets \(U,V\in\mc T\) such that \(H\subseteq U,L\subseteq V,U\cap V=\emptyset\).%
\item\hypertarget{li-58}{}\(\mc T\) is said to be \terminology{\(T_4\)} if and only if it is both normal and \(T_1\)%
\end{enumerate}
\end{definition}
...
\leavevmode%
\begin{enumerate}
\item\hypertarget{li-59}{}\(T_2\) but not regular.%
\item\hypertarget{li-60}{}\(T_3\) but not normal.%
\item\hypertarget{li-61}{}Regular but not \(T_3\).%
\item\hypertarget{li-62}{}Normal but not \(T_4\).%
\item\hypertarget{li-63}{}Normal but not regular.%
\end{enumerate}
\end{example}
...
\end{theorem}
\hypertarget{p-70}{}%
TODO: basis and subbasis, local base, first/second countability%
%
%
\typeout{************************************************}
