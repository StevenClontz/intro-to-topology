...
\hypertarget{p-78}{}%
Let \(\mc S\subseteq\mc P(X)\) and \(\mc T=\bigcap\setBuilder{\mc T^\star}{\mc S\subseteq\mc T^\star \text{ and }
\mc T^\star \text{ is a topology on } X}\). Then \(\mc T\) is a topology.%
\end{theorem}
\hypertarget{p-79}{}%
...
\leavevmode%
\begin{enumerate}
\item\hypertarget{li-66}{}\(\mc T\) is said to be \terminology{regular} if and only if for all points \(x\in X\) and closed subsets \(H\subseteq X\) such that \(x\not\in H\), there exist open sets \(U,V\in\mc T\) such that \(x\in U,H\subseteq V,U\cap V=\emptyset\).%
\item\hypertarget{li-67}{}\(\mc T\) is said to be \terminology{\(T_3\)} if and only if it is both regular and \(T_1\)%
\item\hypertarget{li-68}{}\(\mc T\) is said to be \terminology{normal} if and only if for all closed subsets \(H,L\subseteq X\) such that \(H\cap L=\emptyset\), there exist open sets \(U,V\in\mc T\) such that \(H\subseteq U,L\subseteq V,U\cap V=\emptyset\).%
\item\hypertarget{li-69}{}\(\mc T\) is said to be \terminology{\(T_4\)} if and only if it is both normal and \(T_1\)%
\end{enumerate}
\end{definition}
...
\leavevmode%
\begin{enumerate}
\item\hypertarget{li-70}{}\(T_2\) but not regular.%
\item\hypertarget{li-71}{}\(T_3\) but not \(T_4\)%
\item\hypertarget{li-72}{}Regular but not \(T_3\).%
\item\hypertarget{li-73}{}Normal but not \(T_4\).%
\item\hypertarget{li-74}{}Regular but not normal.%
\item\hypertarget{li-75}{}Normal but not regular.%
\end{enumerate}
\end{example}
